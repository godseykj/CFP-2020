...
teams <- c("Florida", "OSU", "Alabama","ND","Clemson","TA&M","Iowa St","Cincy","Georgia","Miami(FL)","Oklahoma","Indiana","Coastal Carolina","Northwestern","USC","Iowa","UNC","BYU","Louisiana","Texas","Colorado","Oklahoma State","NC State","Tulsa","Missouri")
...
```{r print_table5}
datatable(schedules[["Cincinnati"]], options = list(pageLength = 10))
```
